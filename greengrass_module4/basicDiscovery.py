...
parser.add_argument("-d", "--data", action="store", dest="data", default=None, help="Path to CSV file.")
...
print("\n\n\nRICK\n\n\n")
for ci in coreInfo.connectivityInfoList:
    print("host {} port {}".format(ci.host, ci.port))
print("\n\n\nRICK\n\n\n")
